...
# source: simple_supply_protobuf/agent.proto
...
Agent = _reflection.GeneratedProtocolMessageType('Agent', (_message.Message,), {
  'DESCRIPTOR' : _AGENT,
  '__module__' : 'simple_supply_protobuf.agent_pb2'
